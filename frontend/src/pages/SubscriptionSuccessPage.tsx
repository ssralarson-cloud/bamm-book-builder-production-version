    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-10">
      <div className="w-full max-w-md text-center fade-in">
        ...
        <div className="relative mx-auto mb-6 flex h-24 w-24 items-center justify-center">
          <div className="absolute -left-2 -top-2 h-4 w-4 rounded-full bg-terracotta-200 animate-float" style={{ animationDelay: '0s' }} />
          <div className="absolute -right-3 top-2 h-3 w-3 rounded-full bg-sage-200 animate-float" style={{ animationDelay: '0.5s' }} />
          <div className="absolute -bottom-1 left-0 h-3.5 w-3.5 rounded-full bg-blush-200 animate-float" style={{ animationDelay: '1s' }} />
