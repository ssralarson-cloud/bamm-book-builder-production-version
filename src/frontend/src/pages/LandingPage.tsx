    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-boho-hero py-24 md:py-32">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <p className="fade-in mx-auto mt-4 max-w-xl text-lg leading-relaxed text-cream-700">
            Write your story, add beautiful AI illustrations, and publish a real
            book on Amazon KDP — all from your browser. It's that simple.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-lg text-cream-600">
              No design experience needed. Our tools handle the technical
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {(
              [
                {
                  ...
                  desc: "Add pages, arrange your narrative, set text positions. The editor gives you full creative control.",
                  color:
                ...
                },
                {
                  ...
                  desc: "Describe your scene and our AI creates beautiful, print-quality illustrations matched to your story.",
                  color: "bg-sage-50 text-sage-600 border-sage-100",
                },
                {
                  icon: FileDown,
                  emoji: "3",
                  title: "Export KDP Files",
                  desc: "One click generates your interior PDF and full-wrap cover — perfectly formatted for Amazon KDP.",
                ...
                },
                {
                  ...
                  desc: "Upload your files to KDP, set your price, and your book is available worldwide.",
              ...
              <div
                key={step.title}
                className="boho-card group text-center fade-in"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div
                  className={`mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border ${step.color}`}
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto mt-14 grid max-w-4xl gap-5 md:grid-cols-2">
            {(
              [
                {
                  ...
                  desc: '8.5x8.5" trim, 0.125" bleed, 300 DPI — every spec handled automatically.',
                  accent: "terracotta",
                },
                {
                  icon: Sparkles,
                  title: "AI Illustration Engine",
                  desc: "Powered by Grok AI. Describe your scene, get a print-quality illustration in seconds.",
                  accent: "sage",
                },
                {
                  icon: Palette,
                  title: "Full-Wrap Cover Builder",
                  desc: "Front cover, spine, and back cover on one canvas with automatic spine width calculation.",
                  accent: "blush",
                },
                {
                  icon: Globe,
                  title: "Built on Internet Computer",
                  desc: "Your projects live on-chain. No server to maintain. Your data is yours.",
                  accent: "sage",
                },
                {
                  icon: FileDown,
                  title: "Real PDF Export",
                  desc: "Not a mockup — real files you can upload directly to KDP and hold in your hands.",
                  accent: "terracotta",
                },
                {
                  icon: Shield,
                  title: "Professional Validation",
                  desc: "Automatic preflight checks catch issues before you upload. No rejected manuscripts.",
                  accent: "blush",
                },
              ] as const
            ).map((f, i) => (
              <div
                key={f.title}
                className="boho-card flex items-start gap-4 fade-in"
              ...
              >
                ...
                <div>
                  <h3 className="font-display text-base font-semibold text-cream-900">
                    {f.title}
                  </h3>
                  <p className="mt-1 text-sm leading-relaxed text-cream-600">
                    {f.desc}
                  </p>
                </div>
              </div>
      ...
      <section className="bg-boho-warm py-20">
        <div className="container mx-auto max-w-md px-4 text-center">
          <span className="text-3xl">&#x1F33B;</span>
          <h2 className="mt-3 font-display text-3xl font-bold text-cream-900">
            Simple, Happy Pricing
          </h2>
          <p className="mt-3 text-cream-600">
            Try free. Subscribe when you're ready to export and publish.
          </p>
          ...
          <div className="mt-10 overflow-hidden rounded-3xl border-2 border-terracotta-200 bg-white p-8 shadow-boho-lg">
            ...
            <p className="font-display text-6xl font-bold text-cream-900">
              $19.99
              <span className="text-xl font-normal text-cream-500">/book</span>
            </p>
            ...
            <ul className="space-y-3 text-left">
              {[
                ...
                <li
                  key={item}
                  className="flex items-center gap-3 text-cream-700"
                >
            ...
            <Button
              ...
              data-ocid="landing-subscribe-btn"
            >
              Subscribe Now
            </Button>
