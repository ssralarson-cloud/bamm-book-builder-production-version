  ...
  return (
    <Card className="border-2 border-border">
      <CardHeader>
        ...
        <CardDescription>
          Guidelines for professional print quality
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="trim-bleed">
            ...
            <AccordionContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                <strong>Trim Size:</strong> The final size of your book after
                printing and cutting. This app uses 8.5×8.5" (square format), a
                standard for children's books on Amazon KDP.
              </p>
              <p>
                <strong>Bleed:</strong> Extra 0.125" around all edges where
                images/backgrounds extend beyond the trim line. This prevents
          ...
          <AccordionItem value="safe-margins">
            ...
            <AccordionContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                Keep all important text and images at least 0.5" from the trim
                edge. This ensures nothing critical gets cut during printing.
              </p>
              <div className="rounded-lg border border-border bg-secondary/30 p-2 text-xs">
          ...
          <AccordionItem value="image-quality">
            ...
            <AccordionContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                <strong>300 DPI minimum</strong> is required by Amazon KDP for
                professional print quality. Lower resolution images will appear
                pixelated or blurry.
              </p>
              <div className="rounded-lg border border-border bg-secondary/30 p-2 text-xs">
          ...
          <AccordionItem value="spine-width">
            ...
            <AccordionContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                Spine width is automatically calculated based on page count
                using Amazon KDP's standard formula. Uses 0.002252" per page for
                white paper.
              </p>
              <div className="rounded-lg border border-border bg-secondary/30 p-2 text-xs">
          ...
          <AccordionItem value="file-format">
            ...
            <AccordionContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                Amazon KDP accepts PDF files with specific requirements for
